              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                      ...
                      <option value="Madurai City">Madurai</option>
                      <option value="Pudukottai City">Pudukottai</option>
                      <option value="Palani City">Palani</option>
                      <option value="Dindigul City">Dindigul</option>
                      <option value="Coimbatore City">Coimbatore</option>
                      <option value="Thirupur City">Thirupur</option>
                      <option value="Virudunagar City">Sivakasi</option>
                      <option value="Trichy City">Trichy</option>
                      <option value="Chennai City">Chennai</option>
                      <option value="Tanjore City">Tanjore</option>
                      <option value="Thirunelveli City">Thirunelveli</option>
                      <option value="Theni City">Theni</option>
                      <option value="Tuticorin City">Tuticorin</option>
                      <option value="Erode City">Erode</option>
                      <option value="Salem City">salem</option>
                      <option value="Sivaganga City">Sivaganga</option>
                      </select>  
                      </div>
...
<footer class="footer" data-background-color="black">
            <div class="container">
                ...
                <div class="copyright">
                    ...
                    </script>, Designed and Coded by Gopaal.
                </div>
            </div>
        </footer>
    </div>
