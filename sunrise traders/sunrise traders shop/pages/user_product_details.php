...
?>
                        ...
                        while($res = mysqli_fetch_array($result)){
                                    ...
                                    if (isset($_POST['submit'])){
                                        ...
                                        mysqli_query($dbconn,"INSERT INTO order_details (prod_id,prod_qty,total,user_id,date) 
                                                VALUES ('$prod_id','$prod_qty','$total','$user_id', SYSDATE())") or die(mysql_error());
                                                $qr = "update order_details o
                                                set user_name = (select username  from users u where u.user_id = '$user_id'),shipping_add=(select address  from users u where u.user_id = '$user_id')
                                                where user_id = '$user_id'";
                                                mysqli_query($dbconn,$qr);
                                            ?>
