...
<body class="index-page sidebar-collapse">
    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a href="pages/admin_index.php" class="navbar-brand" rel="tooltip" title="Designed and Coded by Serve(8) Web Solutions, Inc." data-placement="bottom" target="">
                    SUNRISE TRADERS
                </a>
    ...
    <div class="wrapper">
        <div class="page-header clear-filter" filter-color="orange">
            <div class="page-header-image" data-parallax="true" style="background-image: url('./assets/img/note.jpg');">
            
                <div class="container">
                    <div class="content-center brand">
                        <img src="./assets/img/logo2.png" alt="Circle Image" class="rounded-circle" width="50%">
                        <br><br>
                        <h3>Notebook and Calenders</h3>
                    </div>
                </div>
            </div>
        </div>
